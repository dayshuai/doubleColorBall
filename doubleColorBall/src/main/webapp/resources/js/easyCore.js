!function(window, $, undefined) {
    !function() {
        ...
        $.fn.fixPosition = function() {
            var e = this, i, m, t, n, s = function(e, i) {
            ...
            if ("absolute" == e.css("position")) {
                ...
                c = function(s) {
                    ...
                    var h = +r.scrollTop()
                      , f = +r.scrollLeft();
                    if (u)
                        m && e.css("bottom", +m + 1).css("bottom", m + "px");
                    else
                        m && e.css("bottom", $(document).height() - r.height() - h + +m + "px");
                    i && e.css("top", +i + h - o + "px");
                    if (u)
                        n && e.css("right", +n + 1).css("right", n + "px");
                    else
                        n && e.css("right", $(document).width() - r.width() - f + +n + "px");
    ...
    $.extend({
        ...
        addUrlPara: function(e, i, m) {
            var t = (e + "").split("#"), n;
            if (m)
                t[0] = $.removeUrlPara(t[0], $.map(i.match(/([^=&#\?]+)=[^&#]+/g), function(e) {
                    return e.replace(/=.+$/, "")
                }));
            n = t[0].indexOf("?") + 1 ? "&" : "?";
        ...
        fillUrl: function(e) {
            ...
            if (!/^http/i.test(e)) {
                var i = window.location.port || "80"
                  , m = /^\//.test(e);
                if (!m)
                    e = document.URL.replace(/\/[^\/]*$/g, "/") + e;
                else
                    e = window.location.protocol + "//" + window.location.host + ("80" == i ? "" : ":" + i) + e
            }
            return e
        },
    ...
    !function() {
        ...
        $.format = function(i, m) {
            var t = true, n, s, r = m === undefined ? null : $.isPlainObject(m) ? (t = false,
            m) : $.isArray(m) ? m : Array.prototype.slice.call(arguments, 1);
            if (null === r)
                return i;
            n = t ? r.length : 0;
            s = RegExp.regCompile ? /./.compile("^\\d+$") : /^\d+$/;
            return String(i).replace(e, function(e, i) {
                var m = s.test(i), o, a, c;
                if (m && t) {
                    o = parseInt(i, 10);
                    return o < n ? r[o] : e
                } else {
    ...
    $.fn.bindTab = function(e, i, m, t, n) {
        ...
        return this.each(function() {
            var s = $(this), r, o = (t || "active").split("::"), a = m || "li", c = n || "rel", l = i || "mouseenter", u = "mouseenter" == l, h = function(i) {
            ...
            s.delegate(a, l, function() {
                var e = $(this);
                if (e.hasClass(o[0]) || this.disabled)
                    return;
                if (u) {
            ...
            var f = s.find("." + o[0]);
            if (!f[0])
                s.find(a).eq(0).addClass(o[0]);
            s.find(a).each(function() {
                var e = $($(this).attr(c))
                  , i = $(this).hasClass(o[0]);
                if (o[1])
                    e[i ? "removeClass" : "addClass"](o[1]);
                else
                    e[i ? "show" : "hide"]()
            })
        })
    ...
    !function(e) {
        var i, m = function() {}, t = e.document, n = {
            set: m,
            get: m,
            remove: m,
            clear: m,
        ...
        !function() {
            ...
            var n = t.getElementsByTagName("head")[0], s = e.location.hostname || "localStorage", r = new Date, o, a;
            if (!n.addBehavior) {
                try {
                    i = e.localStorage
                } catch (m) {
        ...
        e.LS = !i ? n : {
            ...
            each: function(e) {
                var i = this.obj(), m = e || function() {}
                , t;
                for (t in i)
                    if (false === m.call(this, t, this.get(t)))
                        break
            },
            obj: function() {
                var e = {}, m = 0, t, n;
    ...
    $.hash = function(e, i) {
        if ("string" === typeof e && i === undefined)
            return $.getHashPara(e);
        var m = window.location.hash.replace(/^#*/, "").split("&"), t = {}, n = m.length, s = 0, r, o = {}, a = {}, c, l;
        for (; s < n; s++) {
            r = m[s].split("=");
        ...
        m.length = 0;
        for (l in o)
            m.push(encodeURIComponent(l) + "=" + encodeURIComponent(o[l]));
    ...
    !function() {
        var e = "163.com"
          ...
          , s = function(e, i) {
            ...
            if (r.indexOf(document.domain) > 0)
                f(document.domain = document.domain);
            else
                f(document.domain, function() {
                    if (r.indexOf(document.domain) > 0)
                        f(document.domain);
                    else
                        f("")
          ...
          , a = function(e, t, n, r, o) {
            var a = window.location.host + "", l = m(t) || a, u = "http:", h = "80", f;
            if (/^(https?:)/i.test(t)) {
            ...
            if (i.test(l) && i.test(a) && l.indexOf(document.domain) >= 0 && "http:" == u)
                s(l, function(i) {
                    c(i, e, t, n, r, o)
                });
            else
                c(jQuery, e, t.replace(/https?:\/\/[^\/]+/, ""), n, r, o)
        }
          , n = {}
          , c = function(e, i, m, t, s, a) {
            var c = $.isFunction(s) ? s : $.noop, l = m, u, h, f = window.Core || window, W = false, d = (l.indexOf("?") + 1 ? "&" : "?") + "cache=" + +new Date, p, C;
            if ($.isFunction(t)) {
                c = t;
                t = null;
                a = s
    ...
    !function() {
        var e = {}
          , i = function(i, m, t, n, s) {
            var r = m.toLowerCase().replace(/#.*$/, "").replace("/?.*$/", ""), o, a, c = $.isFunction, l = e[r] || [], u = !!(t || $.noop)(m), h = window.CollectGarbage || $.noop;
            if (u) {
                c(n) && n();
                return
            }
    ...
    !function(e) {
        ...
        Class.extend = function o(e, i) {
            ...
            for (var h in i)
                if (i.hasOwnProperty(h))
                    if ("function" == typeof i[h] && "function" == typeof l[h]) {
                        var f = l[h];
                        if (!f.__isAgent)
                            f = s(r(h + "方法被子类覆盖，但是父类没有同名函数，不能调用callSuper!"), l[h]);
                        a[h] = s(f, i[h])
                    } else
                        a[h] = i[h];
            function W() {}
        ...
        function n(e) {
            if (!e)
                return i;
            if (!/^(?:Base|Tools|Widgets|Game|Page)\./.test(e))
                return m("Class命名空间错误，一级命名空间只能是:Base、Tools、Widgets、Game、Page");
            var t = e.split("."), n = t.length, s = 0, r = Class, o;
            for (; s < n - 1; s++) {
                o = t[s];
                r = r[o] = r[o] || {}
            }
            o = t[n - 1];
            if (r[o])
                return m("已经有同名Class存在，请更换名称或路径！");
            return function(e) {
                r[o] = e
            }
        }
        function s(e, i) {
            var m = function() {
                var m = this.hasOwnProperty("callSuper"), t = this.callSuper, n;
                this.callSuper = e;
    ...
    !function(e) {
        ...
        var r = e.extend({
                ...
                $.each(e.split(" "), function(e, r) {
                    ...
                    m && (t[r] = function(e) {
                        if (s(e)) {
                            ...
                            return t.trigger.apply(t, [r].concat(i.call(arguments, 0)))
                    }
                    )
                })
            },
            trigger: function(e, m) {
                var t, n = 0, s = this, r = i.call(arguments, 1);
                if (!isNaN(e) && e && +e > 0) {
                    if ("string" !== typeof m)
                        return 1;
                    t = this.eventCache[m || ""];
                ...
                if ("number" === typeof e && (isNaN(e) || e < 0)) {
                    ...
                    t = this.eventCache[m || ""];
                    if (t)
                        this.warn("事件" + m + "设置的缓冲保护时间不是合法数字")
                } else {
            ...
            unbind: function(e, i) {
                ...
                for (var t = 0; t < m.length; t++)
                    if (m[t] === i || i.muid && m[t].muid === i.muid) {
                        m.splice(t, 1);
                        t--
                    }
                return 0
        ...
        r.extend("Base.Event", {
            ...
            trigger: function(e) {
                ...
                if (i && !isNaN(i))
                    this.warn(["trigger事件名称必须是字符串", "未注册的事件(" + e + ")不能trigger"][i - 1]);
                if (false === i)
                    return false
            },
            bind: function(e) {
                var i = this.callSuper.apply(this, arguments);
                if (i)
                    this.warn(["bind事件名称必须是字符串", "未注册的事件(" + e + ")不能bind", "bind(" + e + ")注册事件必须是函数"][i - 1]);
                return this
            },
            unbind: function(e) {
                if (!e) {
            ...
            bindOnce: function(e) {
                var i = this.callSuper.apply(this, arguments);
                if (i)
                    this.warn(["bindOnce事件名称必须是字符串", "未注册的事件(" + e + ")不能bindOnce", "bindOnce(" + e + ")注册事件必须是函数"][i - 1]);
                return this
            }
        })
    }(window.Class);
    !function() {
        var e = function(e, i, m) {
            if (window.addEventListener)
                e.addEventListener(i, m, !1);
            else
                e.attachEvent("on" + i, m)
        };
        var i = function(e, i, m) {
            if (window.removeEventListener)
                e.removeEventListener(i, m);
            else
                e.detachEvent("on" + i, m)
        };
        var m = {}, t, n, s = [], r;
        m.flag = !1;
        ...
        m.getIframeCss = function() {
            ...
            if (this.__iframeShowAnimation)
                var e = "-webkit-animation:" + this.__iframeShowAnimation + ";-moz-animation:" + this.__iframeShowAnimation + ";-ms-animation:" + this.__iframeShowAnimation + ";-o-animation:" + this.__iframeShowAnimation + ";animation:" + this.__iframeShowAnimation + ";";
        ...
        m._$supportCss3 = function(e) {
            var i = ["webkit", "Moz", "ms", "o"], m, t = [], n = document.documentElement.style, s = function(e) {
        ...
        window.URS = function(l, u, h) {
            ...
            if ("string" == typeof l)
                ...
                f = l;
            if (h.logincb)
                this.logincb = h.logincb;
            if (h.closecb)
                this.closecb = h.closecb;
            if (h.regcb)
                this.regcb = h.regcb;
            ...
            if (!this.isInclude && f && W)
                e(f, W, this.showIframe);
            else
                this.includeBox = this.isInclude;
            if (m.needPrepare || this.isInclude)
                this.prepareIframe();
            var C = function(e) {
                if (e)
            ...
            var B = function(e) {
                ...
                if (t) {
                    ...
                    if (!t["URS-READY"] || !y.isInclude && m.needPrepare) {
                        if (t["URS-READY"] && !m._initReady)
                            m._initReady = !0;
                        if (t["URS-CM"] && document.getElementById("x-URS-iframe"))
                            if ("success" == t.type) {
                                if (y.logincb)
                                    y.logincb(t["username"], t["isOther"]);
                                if (!this.isInclude) {
                                    if (f && W)
                                        i(f, W, y.showIframe);
                                    y.closeIframe()
    ...
    !function($) {
        if (!$)
            return void (window.console && console.log("need jquery."));
            ...
            var cookie = $.cookie
              , login = function() {
                ...
                var i = {
                  ...
                  , m = {
                    fillUrl: function(e) {
                        if ("string" != typeof e || !e || /^(?:http|javascript)/i.test(e))
                            return e;
                        if (/^#/.test(e))
                            return document.URL.replace(/#.*$/, "") + e;
                        if (/^\//.test(e)) {
                            var i = ":" + (window.location.port || "80");
                    ...
                    checkOptions: function(e, t, n) {
                        ...
                        s.cssFiles = function(e, i) {
                            return s.cssDomain ? e ? i ? e + "," + i : e : i : ""
                        }(s.baseCssFiles, s.cssFiles),
                        s.callback = function(e, i) {
                            return function(m, t) {
                                if ("giveup" === t)
                                    $.isFunction(i) && i();
                                else {
                    ...
                    getSite: function(e) {
                        var i = e + "";
                        for (var t in m.uninIdReg)
                            if (m.uninIdReg[t].test(i))
                                return t
                    },
                    cookie: {
                        getSInfo: function() {
                  ...
                  , r = function(e, i) {
                    ...
                    if (m.urs)
                        return m._callback = n.callback,
                        void o(m.urs, n);
                    var a = new URS(n);
                    m._callback = n.callback,
                    m.urs = a,
                    a.logincb = s("onLogin", function(e) {
                        m.ursId = e,
                        m._callback(e, "login"),
                        globalMsg.sendMsg("login.success", e),
                        globalMsg.sendMsg("login.change")
                    }, "logincb"),
                    a.regcb = s("onLogin", function(e) {
                        m.ursId = e,
                        m._callback(e, "reg"),
                ...
                $.extend(r, {
                    ...
                    setURSId: function(e) {
                        ...
                        globalMsg.sendMsg("login.off"),
                        globalMsg.sendMsg("login.change")))
                    },
                    getNickName: function() {
                        var e = m.cookie.getPInfo()
                          , i = this.getURSId();
                        e.base !== i && (e.base = e.alias = i,
                        e.site = m.getSite(i) || "163");
                ...
                var options = {
                  ...
                  , hookFn = function(e, i) {
                    if ($ && $.fn && $.fn.bindDrag && e && e[0]) {
                        ...
                        e.prepend(t),
                        e.prepend(m);
                        var n, s, r, o = "fixed" == e.css("position").toLowerCase(), a = o ? function(e) {
                            return {
                                left: e[0].offsetLeft,
                                top: e[0].offsetTop
                            }
        ...
        var a = {
          ...
          , c = {
            ...
            entrys: [{
                ...
                if (!e || !e.username || e.username.indexOf("@") < 0)
                    return;
          ...
          , l = {
            ...
            repaint: function() {
                ...
                if (m)
                    l.bindDropMenu(m, i("#user163List")[0], "mouseover", "user163BoxActive", i.noop, 200);
            ...
            onLogin: function(e) {
                if (i.isFunction(e))
                    i.bindMsg("login.success", e);
                if (m.isLogin && m.isLogin())
                    e(m.getSite(), m.getURSId());
                l.repaint()
            },
                ...
                this.data = {
                    ...
                    nameHolder: function() {
                        ...
                        if (null === n || false === n)
                            return m.getAccount();
                        if (true === n)
                            return u.get163Entry(m.getAccount());
                        if (n)
                            return i.safeHTML(n + "");
                        if ("163" === m.getSite())
                            return u.get163Entry();
    ...
    !function() {
        function i() {
            ...
            this.d = function(m) {
                if (null == m || void 0 == m)
                    return m;
                if (m.length % e[10] != e[11])
                    throw Error("1100");
                for (var t = [], n = e[11]; n < m.length; n++) {
                    n % e[10] == e[11] && t.push("%");
                    for (var s = i, r = e[11]; r < s.length; r++)
                        if (m.charAt(n) == s[r]) {
        ...
        !function() {
            function i(i, m) {
                if (null == i)
                    return null;
                for (var t = v(m), n = [], s = i.length, r = e[11]; r < s; r++)
                    n.push(y(i[r], t--));
                return n
            }
            function o(i, m) {
            ...
            function c(i) {
                var m = [];
                if (null == i || void 0 == i || i.length == e[11])
                    return h(ri);
                if (i.length >= ri) {
                    var m = e[11]
                      , n = [];
                    if (null != i && i.length != e[11]) {
                        if (i.length < ri)
                            throw Error(t("ChCBCBCC"));
                        for (var s = e[11]; s < ri; s++)
                            n[s] = i[m + s]
                    }
                    return n
                }
            ...
            function l(i) {
                var t = e[401];
                if (null != i)
                    for (var n = e[11]; n < i.length; n++)
                        t = t >>> e[33] ^ ti[(t ^ i[n]) & e[295]];
                i = W(t ^ e[401]);
                t = i.length;
                if (null == i || t < e[11])
                    i = new String(m(""));
                else {
                    for (var n = [], s = e[11]; s < t; s++)
                        n.push(C(i[s]));
                    i = n.join(m(""))
                }
                return i
            ...
            function u(i, o, a) {
                var c, l = [n("WW"), s("3C"), m("Ch"), n("Wi"), r("3e"), r("36"), m("WB"), t("CW"), t("mW"), t("34"), t("mK"), t("m2"), s("ih"), m("33"), m("3h"), t("iC"), t("sG"), n("my"), m("C3"), t("i4"), s("sd"), r("Wm"), r("mi"), t("iK"), m("mh"), t("mm"), m("WC"), m("32"), m("Cs"), m("3K"), t("CB"), t("mC"), r("3W"), t("3m"), m("W3"), s("im"), m("Wh"), t("C4"), r("i3"), t("3y"), n("md"), t("iW"), m("Ws"), s("WK"), s("ms"), t("3i"), r("Wy"), s("iB"), m("is"), n("m4"), m("Cy"), t("mG"), t("m6"), m("ii"), s("3s"), s("3G"), n("iy"), n("Ci"), t("W4"), n("CC"), t("3d"), t("me"), n("ie"), m("m3")], u = n("Cm"), h = [];
                if (a == e[536])
                    a = i[o],
                    c = e[11],
            ...
            function f(i, m, t, s, r) {
                if (null != i && i.length != e[11]) {
                    if (null == t)
                        throw Error(n("ChCBCBC3"));
                    if (i.length < r)
                        throw Error(n("ChCBCBCC"));
                    for (var o = e[11]; o < r; o++)
                        t[s + o] = i[m + o]
                }
            }
            function W(i) {
            ...
            function d(i) {
                ...
                for (var t = [], n = i.length, o = e[11]; o < n; o++)
                    if (i.charAt(o) == r("si"))
                        if (o + e[10] < n)
                            t.push(p(i.charAt(++o) + m("") + i.charAt(++o))[e[11]]);
                        else
                            throw Error(s("ChCBCBC4"));
                    else
            ...
            function g(i, m) {
                if (null == i || null == m || i.length != m.length)
                    return i;
                for (var t = [], n = e[11], s = i.length; n < s; n++)
                    t[n] = y(i[n], m[n]);
                return t
            }
            function y(e, i) {
            ...
            function v(i) {
                if (i < e[286])
                    return v(e[287] - (e[286] - i));
                if (i >= e[286] && i <= e[278])
                    return i;
                if (i > e[278])
                    return v(e[288] + i - e[278]);
            ...
            function w(i) {
                ...
                function a() {
                    ...
                    u.innerHTML = a;
                    for (a = e[11]; a < s.length; a++)
                        o[a] = i(s[a]);
                    return function(m) {
                        for (var n = e[11]; n < o.length; n++) {
                            var r = i(m + t("se") + s[n])
                              , a = o[n];
                            if (r.height !== a.height || r.width !== a.width)
                                return !0
                        }
                        return !1
                    }
                ...
                function u() {
                    ...
                    if (!window[t("mWmiW33CmGm6WBWiW3mim3iCW3W4memi")])
                        return o.join(t(""));
                    for (var c = e[11]; c < a.length; c++)
                        try {
                ...
                function y(i, m) {
                    if (null !== i)
                        if (B && i.forEach === B)
                            ...
                            for (var t = e[11], n = i.length; t < n && m.call(void 0, i[t], t, i) !== {}; t++)
                                ;
                        else
                            for (t in i)
                                if (i.hasOwnProperty(t) && m.call(void 0, i[t], t, i) === {})
                                    break
                }
                ...
                typeof i == m("mmWim2mCW3m4mGm2") ? w.e = i : (null != i.b && void 0 != i.b && (w.b = i.b),
                null != i.a && void 0 != i.a && (w.a = i.a));
                this.get = function() {
                    var i = []
                      , a = [];
                    if (Q) {
                        ...
                        w.j && (l = window[r("WCmCWsmimim2")] ? [window[n("WCmCWsmimim2")].height, window[r("WCmCWsmimim2")].width] : [e[11], e[11]],
                        typeof l !== m("Wim2m3mimmm4m2mim3") && a.push(l.join(m("Wy"))));
                        a.push((new Date)[n("mWmiW3i3m4m6miWKmGm2mi3GmmmmWCmiW3")]());
                        a.push(Z[n("m3mG32mGW3i3WsmhmCmd")]);
                        a.push(f())
                    }
                    l = [];
                    w.e ? (l.push(w.e(i.join(r("sCsCsC")))),
                    l.push(w.e(a.join(t("sCsCsC"))))) : (l.push(G(i.join(m("sCsCsC")))),
                    l.push(G(a.join(r("sCsCsC")))));
                    return l
                }
            }
            function G(i) {
                var o = e[84], a, c, l, u, h, f;
                a = i.length & e[14];
                c = i.length - a;
                l = o;
                o = e[16];
                u = e[372];
                for (f = e[11]; f < c; )
                    h = i.charCodeAt(f) & e[295] | (i.charCodeAt(++f) & e[295]) << e[33] | (i.charCodeAt(++f) & e[295]) << e[54] | (i.charCodeAt(++f) & e[295]) << e[70],
                    ++f,
                ...
                a.push(i);
                try {
                    for (var W, d = i + n(""), p = e[11], C = e[11], g = e[11]; g < d.length; g++)
                        try {
                    ...
                    C = C == e[11] ? e[536] : C;
                    W = b(p * e[536] / C, ei);
                    for (var v, w = Math.floor(W / Math.pow(e[38], ei - e[536])), G = i + n(""), S = e[11], k = e[11], j = e[11], $ = e[11], M = e[11]; M < G.length; M++)
                        try {
            ...
            function b(i, m) {
                if (i < e[11] || i >= e[38])
                    throw Error(r("ChChChCB"));
                for (var o = I(m, t("CB")), a = s("") + i, c = e[11], l = e[11]; c < o.length && l < a.length; l++)
                    a.charAt(l) != n("s2") && (o[c++] = a.charAt(l));
                return parseInt(o.join(t("")))
            }
            function x(e, i, t) {
                e = r("") + e;
                if (e.length > i)
                    throw Error(m("ChChChCh"));
                if (e.length == i)
                    return e;
                for (var n = [], o = e.length; o < i; o++)
                    n.push(t);
                n.push(e);
                return n.join(s(""))
            }
                                        ...
                                        if (g) {
                                            ...
                                            if (B) {
                                                ...
                                                if (w) {
                                                    ...
                                                    a = $(Y, r("Wim2miWCmCmhWBmi"))
                                            } else
                                                a = $(Y, s("miWCmCmhWBmi"))
                                        } else
                                            a = $(Y, t("mim2mCmGm3miiiis343CmGm6WBmGm2mim2W3"))
                                    } else
                                        a = $(Y, r("mim2mCmGm3miiiis34"))
                                } else
                                    a = $(Y, s("m3mimCmGm3miiiis343CmGm6WBmGm2mim2W3"))
                            } else
                                a = $(Y, t("m3mimCmGm3miiiis34"))
                        } else
                            a = $(Y, s("WBmhWsWCmi34m2W3"))
                    } else
                        a = $(Y, r("WBmhWsWCmi3mmemGmhW3"))
                } else
                    a = i;
                return a
            }
            ...
            function L(i) {
                ...
                if (typeof i == [s("mGms"), t("mKmi"), s("mCW3")].join(n(""))) {
                    for (var a = a + r("Wd"), c = e[11]; c < o.length; c++)
                        if (i.hasOwnProperty(o[c])) {
                            var l = n("sW") + o[c] + m("sWCKsW"), u;
                            u = m("") + i[o[c]];
            ...
            function N(e, i, o, a) {
                ...
                c.push(n("WBmh"));
                c.push(n("W3myC6sG"));
                null != Bi && void 0 != Bi && Bi != t("") && (c.push(t("CdsB")),
                c.push(r("m3mG")),
                c.push(t("m6mhm4")),
                c.push(n("m2C6")),
                c.push(Bi));
            ...
            function J() {
                if (!(null == Gi || void 0 == Gi || Gi.length <= e[11]))
                    for (var i = e[11]; i < Gi.length; i++) {
                        var m = Gi[i];
                        (null != Bi && void 0 != Bi && Bi != n("") || null != m && void 0 != m && m != n("")) && Bi != m && (z(li, m),
                        z(ui, m))
                    }
            }
            function q() {
                ...
                try {
                    ...
                    null != G && void 0 != G && G.length > e[11] ? p[s("mmWB")] = G.join(s("se")) : (p[t("mmWB")] = R(n("CB"), e[38]),
                    p[r("mimC")] = n("Ch"),
                    m = !1)
                } catch (b) {
                ...
                try {
                    ...
                    var k = c(k), k = g(k, c(I)), j = k = c(k), M;
                    if (null == S || void 0 == S || S.length == e[11])
                        M = h(si);
                    else {
                        var _ = S.length
                          , O = e[11]
                          ...
                          , $ = [];
                        f(S, e[11], $, e[11], _);
                        for (var F = e[11]; F < O; F++)
                            $[_ + F] = e[11];
                        f(W(_), e[11], $, _ + O, oi);
                        M = $
                    }
                    _ = M;
                    if (null == _ || _.length % si != e[11])
                        throw Error(r("ChCBCBCi"));
                    M = [];
                    for (var P = e[11], K = _.length / si, H = e[11]; H < K; H++) {
                        M[H] = [];
                        for (var z = e[11]; z < si; z++)
                            M[H][z] = _[P++]
                    }
                    P = [];
                    f(I, e[11], P, e[11], ai);
                    for (var Y = M.length, Q = e[11]; Q < Y; Q++) {
                        var X, Z = o(M[Q], e[82]), ei = i(Z, e[194]), ii = i(ei, e[215]);
                        X = o(ii, e[173]);
                        var mi = g(X, k), ti;
                        K = mi;
                        H = j;
                        if (null == K)
                            ...
                            for (var z = [], ni = H.length, ri = e[11], fi = K.length; ri < fi; ri++)
                                z[ri] = v(K[ri] + H[ri % ni]);
                            ti = z
                        }
                        var mi = g(ti, j)
                    ...
                    if (null == P || void 0 == P)
                        yi = null;
                    else if (P.length == e[11])
                        yi = n("");
                    else {
                        var Bi = e[14];
                        try {
                            for (var Y = [], Gi = e[11]; Gi < P.length; )
                                if (Gi + Bi <= P.length)
                                    Y.push(u(P, Gi, Bi)),
                                    Gi += Bi;
                                else {
            ...
            var Y = [new k(m("WWm4m2m3mGWW"),t("CBCBCBCB")), new k(s("m3mGmCWim6mim2W3"),n("CBCBCBCh")), new k(m("m2mhWmm4mWmhW3mGWs"),n("CBCBCBCs")), new k(s("memGmCmhW3m4mGm2"),s("CBCBCBCC")), new k(s("mym4WCW3mGWsW4"),m("CBCBCBC3")), new k(r("WCmCWsmimim2"),m("CBCBCBCW")), new k(r("WBmhWsmim2W3"),m("CBCBCBCy")), new k(t("W3mGWB"),r("CBCBCBC4")), new k(t("WCmimemm"),n("CBCBChCB")), new k(n("WBmhWsWCmi3mmemGmhW3"),t("CBChCBCB")), new k(s("WBmhWsWCmi34m2W3"),t("CBChCBCh")), new k(m("m3mimCmGm3miiiis34"),s("CBChCBCs")), new k(r("m3mimCmGm3miiiis343CmGm6WBmGm2mim2W3"),m("CBChCBCC")), new k(r("mim2mCmGm3miiiis34"),r("CBChCBC3")), new k(s("mim2mCmGm3miiiis343CmGm6WBmGm2mim2W3"),s("CBChCBCi")), new k(m("miWCmCmhWBmi"),r("CBChCBCm")), new k(m("Wim2miWCmCmhWBmi"),m("CBChCBCW")), new k(s("miWmmhme"),m("CBChCBCy")), new k(s("iGWBmymhm2W3mGm6"),m("CBCsCBCB"),!1), new k(r("mCmhmemeiBmymhm2W3mGm6"),s("CBCsCBCh"),!1), new k(m("WBmymhm2W3mGm6"),n("CBCsCBCs"),!1), new k(m("WBmymhm2W3mGm6s2m4m2mKmimCW33KWC"),m("CBCsCBCC"),!1), new k(t("mCmGm2W3miWyW3s2mymhWCmy3CmGm3mi"),s("CBCsChCh"),!1)]
              ...
              , Bi = n("")
              , Bi = function(i, s) {
                if (null == i || void 0 == i || i == n("") || null == s || void 0 == s || s.length <= e[11])
                    return null;
                s = s.split(m("Cd"));
              ...
              , Gi = function(i) {
                ...
                if (!i)
                    return m;
                i = i.split(t("s2"));
                for (var n = r(""), o = e[11]; o < i.length; o++)
                    o < i.length - e[536] && (n = s("s2") + i[i.length - e[536] - o] + n,
                    m.push(n));
                return m
            }(yi);
            Gi.push(null);
            ...
            A(O()),
            yi = H(),
            window[r("WCmiW3i3m4m6mimGWiW3")] && window[r("WCmiW3i3m4m6mimGWiW3")](q, yi))
        }()
    }()
}();
var Core = function(e, i, m) {
    var t = document.domain
      , n = t.indexOf("bbs.") >= 0;
    if (/.*\.caipiao\.163\.com$/i.test(t) && !n)
        try {
            document.domain = "caipiao.163.com"
        } catch (s) {}
    if (/.*\.*(?:cai|cp)\.163\.com$/i.test(t))
        try {
            document.domain = "163.com"
        } catch (s) {}
    var r = false;
    var o = ["qq", "weixin"];
    if ("58tc" === i.cookie("unionLogin"))
        o.push("wuba");
    ...
    i.login.hook({
        getNickName: function(e) {
            ...
            case "qq":
            case "weixin":
                var m = i.cookie("CPThirdPartyInfo") || "{}", t;
                try {
    ...
    var c = {
        ...
        log: i.getPara("debugger") && e.console ? function() {
        ...
        navInit: function(e, i, m, t) {
            ...
            if (this.userPage || this.privatePage)
                this.navConfig.logoutUrl = "http://reg.163.com/Logout.jsp?username={username}&url=" + encodeURIComponent("http://caipiao.163.com/reg/logoutredirect.html?gotoUrl=" + encodeURIComponent("//caipiao.163.com"));
        ...
        gameAct: {
            is: function(m, t, n) {
                ...
                var s = c.gameActConfig[m], r = c.serverTime(), o = false, a, l = 0, u = "", h;
                if (i.isFunction(t)) {
                    n = t;
                    t = ""
                }
                if (s) {
                    h = i.isFunction(n) ? function(e) {
                        n.call(s, e)
                    }
                    : i.noop;
                    a = i.isArray(s.type);
                        ...
                        if ("server" == s.range) {
                            var f = function() {
                                ...
                                if (!i)
                                    return;
                                if (i[m])
                                    n = t ? a ? s.type[i[m] - 1] == t : s.type == t : a ? s.type[i[m] - 1] : s.type;
                                return n
                            };
                            if (e.gameActConf)
                                o = f();
            ...
            list: function(e) {
                ...
                if (!c.gameActConfig)
                    c.loadCdnJS("js2/config.js", function() {
                        for (var e in c.gameActConfig)
                            t(e)
                    });
                else
                    for (var n in c.gameActConfig)
                        t(n)
            }
        },
        fastInit: function(e) {
            if (r)
                i("#myEpay").addClass("hide3");
            easyNav.onLogin(function() {
                c.getEpayInfo();
                if (null !== i.cookie("COOKIEYIMAFROM") && null !== i.cookie("COOKIEYIMACPC"))
                    c.loadCdnJS("js2/popularize/entry.js")
            });
            if (c.eventWrap && c.events && i.fn.easyEvents)
                i(c.eventWrap).easyEvents(c.events, c);
        ...
        dealCPPara: function() {
            var i = e.document, m = i.getElementsByTagName("a"), t = m.length, n = 0, s, r, o;
            for (; n < t; n++) {
                r = m[n];
        ...
        updateLogo: function() {
            var m = function() {
                ...
                if (m) {
                    ...
                    if (s && s.img) {
                        ...
                        if ("1" == s.outUrl)
                            i(".logoLnk").addClass("outLogoLnk").attr("href", s.url || "/");
                        else if (s.url) {
            ...
            if (e.logoConf)
                ...
                i.bindMsgOnce("globalConfig", m);
            return this
        },
        checkAd: function() {
            if (this.is4050x || this.hideAd || e.self !== e.top)
                return;
            var m = this
              , t = function() {
                var t = e.adConfig, n, s = m.pageId4Ad, r, a = 0;
                if (t)
                    i.each(t, function(e, i) {
                        if (i.id && i.png && i.url) {
                            i.page = +(i.page || 3);
                            if (4 == i.type || 5 == i.type)
                                m.showPngAd(i, "", "");
                            else if (i.page & s)
                                m.showPngAd(i, "", function(e) {
                                    if (!e && c.indexAdInit)
                                        c.indexAdInit()
                                })
                        }
            ...
            if (/reg\.163\.com/i.test(a) || /reg\.youdao\.com/i.test(a))
                a = "";
            if (a && !/caipiao\.163\.com$/.test(a) && !/(?:cai|cp)\.163\.com$/.test(a) && !this.is4050x && e.top == e.self)
                o = function() {
        ...
        init: function() {
            ...
            var m = i("#hot_block")
              ...
              , n = function(e) {
                ...
                var i = e.find(".showmore")
                  , m = e.attr("style");
                if (e.css("height", "auto").height() - e.removeAttr("style").height() <= 12)
                    i.hide();
                e.attr("style", m)
            };
            n(m);
            ...
            i(document).delegate("a[csrf],a.csrf", "click", function() {
                var e = i(this).attr("href") || "", m = i(this).attr("csrf") || "csrf", t;
            ...
            if (i.getPara("debug"))
                i.cookie("debug", "true" === i.getPara("debug") ? "true" : null, {
                    path: "/"
                });
            ...
            var o = i(".scrollWrap");
            o[0] && o.xScrollGrid();
            if (i.getUrlPara("showDownloadClient"))
                this.clientDom();
            ...
            if (!a || "string" == !typeof a) {
                if (c.config && c.config.gameEn)
                    a = c.config.gameEn;
                if (e.Game) {
                    if (Game.gameEn)
                        a = e.Game.gameEn;
                    if (e.Game.config && e.Game.config.gameEn)
                        a = e.Game.config.gameEn
                }
            }
            if (!/(orderview_detail|MyFollow_detail)\.html/i.test(location.href))
                this.checkGamePause(a);
            delete this.init;
            delete this.myInit;
        ...
        emptySendHttp: function(i) {
            var m = "imgLoad_" + +new Date + parseInt(100 * Math.random()), t, n;
            t = e[m] = new Image;
            t.onload = function() {
                e[m] = null;
                _ntes_void()
        ...
        zclip: e.clipboardData ? function(m, t, n) {
            i(m).click(function() {
                var m = true
        ...
        initMyCoupon: function() {
            var m = i("#myCoupon .couponContent"), t, n = function(t) {
                var s, r, o = '<dl><dt><span class="couponName">名称</span><span class="couponMoney">可用金额(元)</span><span class="couponRange">适用范围</span></dt>{0}</dl>', a = '<dd class="{ddClass}"><span class="couponName">{couponName}</span><span class="couponMoney">{remainAmount}</span><span class="couponRange" title="{ruleDesc}">{ruleDesc}</span></dd>', c = '<a target="_blank" href="//caipiao.163.com/my/coupon.html#from=top" class="seeCoupon">查看全部<i>{couponNum}</i>个红包</a>', l = [], u = [], h = 0, f;
                try {
                    if ("string" == typeof t)
                        t = this.parseJSON(t);
                    r = t.accountId;
                    if (r && r != e.easyNav.sessionId)
                        i.login.setURSId(r);
                    if (t && t.couponList) {
                        s = t.couponList;
                        f = s.length;
                        if (f > 0) {
                            ...
                            if (t.couponNum && t.couponNum > 3)
                                l.push(i.format(c, t));
                            m.html(l.join(""))
                        } else
                            m.html('<div class="tip"><i class="iconHappy"></i>您当前没有可以使用的红包</div>')
                    } else if (t.status == -1)
                        m.html('<div class="tip"><i class="iconHappy"></i>您没有登录，请<a href="javascript:easyNav.login();" target="_self">登录</a>后查看</div>');
                    else if (t.status == -2)
                        m.html('<div class="tip"><i class="iconHappy"></i>您当前没有可以使用的红包</div>');
                    else
        ...
        initNav: function() {
            ...
            var m = i("#topNavRight li:eq(2)")
              ...
              , n = function() {
                ...
                if (t && (new Date).getTime() - t.time < 10 * 60 * 1e3)
                    s(t.data);
                else
                    c.get("http://caipiao.163.com/activity/newUserPayAds.html?memType=myordermenu", function(e, i) {
                        if (!e) {
                            s(i);
                            t = {
                                data: i,
            ...
            m.bind("mouseover", n);
            if (i.getUrlPara("isShowLogin") && !this.easyNav.isLogin())
                this.easyNav.login();
        ...
        initLotteryList: function() {
            var m = i("#lotteryListEntry"), t = i("#lotteryList"), n = i("#funcTab"), s = i(".lotteryListWrap", t), r = false, o, a = function(e) {
                ...
                t.css("display", "block");
                e.each(function(e, t) {
                    var n = i(this), s = i("h3", n), r = i(".exBox", n), o, a, c = +n.attr("data-maxrow"), l, u = n.height();
                    s.css({
                        height: u - (u / 2 - 16),
                        "padding-top": u / 2 - 16
                    });
            ...
            if (t[0]) {
                function h() {
                    var m = e.lotteryListConf, t, n, r, o, a, c, l, h = "", f = ["", "高频", "竞技", "数字"], W = ["", 4, 2, 2], d = {
                        jclq_mix_p: "jclq"
                    }, p;
                    if (m) {
                        t = m.top;
                ...
                if (e.lotteryListConf)
                    h();
                else
                    i.bindMsgOnce("globalConfig", h);
        ...
        dealKuai2: function() {
            ...
            if (e.kuai2Display)
                ...
                i.bindMsgOnce("globalConfig", function() {
                    t(e.kuai2Display)
                });
            delete this.dealKuai2
        },
        getEpayInfo: function() {
            if (!i("#myEpay")[0] || this.getEpayInfo.lock || this.isStatic)
                return this;
            ...
            m && this.get("//caipiao.163.com/epayAccountInfo.html", function(e, m) {
                if (e || !m)
                    return;
                var n = this.parseJSON(m), r = n.accountId || "", o;
                i.login.setURSId(r);
                var a = 1 == n.ifDisplayBalance, c = +n.epayStatus || 0, l = i("#myEpay"), u, h;
                switch (c) {
                case 1:
                    h = s.center;
                    if (a)
                        u = "余额：<strong class='c_ba2636'>" + n.epayBalance + "</strong> 元 <a href='" + s.charge + "' target='_blank'>充值</a>";
                    break;
                case 123:
                    h = s.center;
